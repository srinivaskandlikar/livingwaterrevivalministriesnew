...
/* themes/mbase/templates/navigation/toolbar.html.twig */
class __TwigTemplate_a87dca8146068fbecbf6702daa98498610c132ef47a33b692b9d1e864023b282 extends Twig_Template
{
    ...
    {
        $tags = array("for" => 26, "spaceless" => 31, "if" => 33);
        $filters = array();
        $functions = array();

        try {
            $this->env->getExtension('Twig_Extension_Sandbox')->checkSecurity(
                array('for', 'spaceless', 'if'),
                array(),
                array()
            );
  ...
  ";
        // line 30
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["trays"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["tray"]) {
            ...
            // line 32
            echo "    <div";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["tray"], "attributes", array()), "html", null, true));
            echo ">
    ";
            // line 33
            if ($this->getAttribute($context["tray"], "label", array())) {
                ...
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["tray"], "label", array()), "html", null, true));
                echo "\">
    ...
    ";
            ...
            // line 39
            echo "        ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["tray"], "links", array()), "html", null, true));
            echo "
      </nav>
    </div>
    ";
...
";
    ...
    {
        return "themes/mbase/templates/navigation/toolbar.html.twig";
    }
    ...
    {
        return array (  116 => 44,  110 => 43,  102 => 39,  98 => 37,  93 => 35,  88 => 34,  86 => 33,  81 => 32,  78 => 31,  74 => 30,  71 => 29,  60 => 27,  56 => 26,  52 => 25,  48 => 24,  43 => 23,);
    }
    ...
    {
        return new Twig_Source("", "themes/mbase/templates/navigation/toolbar.html.twig", "C:\\wamp64\\www\\livingwaterrevivalministriesnew\\themes\\mbase\\templates\\navigation\\toolbar.html.twig");
    }
}
